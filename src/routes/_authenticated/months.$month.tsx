      ...
      <div className="relative rounded-2xl overflow-hidden card-elev">
        <div className="brand-gradient p-8 md:p-12 text-white">
          ...
          <div className="mt-6 max-w-2xl">
            <p className="text-2xl md:text-3xl font-semibold leading-relaxed">{m.verse}</p>
            <p className="mt-2 text-sm opacity-90">{m.ref}</p>
            <div className="mt-6 h-px bg-white/30" />
            <p className="mt-4 text-lg opacity-95">{m.line}</p>
          </div>
        </div>
      </div>
