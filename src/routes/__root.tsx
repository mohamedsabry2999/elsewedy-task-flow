    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4" dir="rtl">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-md border px-4 py-2 text-sm hover:bg-accent hover:text-accent-foreground">
            الرئيسية
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elsewedy Task Flow — إدارة مهام السيلز والتصميم" },
      { name: "description", content: "منصة إدارة مهام السيلز والتصميم لدار السويدي للطباعة" },
      { property: "og:title", content: "Elsewedy Task Flow — إدارة مهام السيلز والتصميم" },
      { property: "og:description", content: "منصة إدارة مهام السيلز والتصميم لدار السويدي للطباعة" },
